    						...
    						<tbody>
    							...
    							<?php foreach ($pengumuman as $key) : ?>
    								<tr>
    									...
    									<td>
    										<a href="<?= base_url("admin/admin/updatePengumuman/$key[id]"); ?>" class="badge badge-success updatePengumumanModalButton" data-toggle="modal" data-target="#newPengumumanModal" data-id="<?= $key['id'] ?>">Ubah</a>
    										<a href="<?= base_url("admin/admin/deletePengumuman/$key[id]"); ?>" class="badge badge-danger" onclick="return confirm('Are you sure?');">Hapus</a>
    									</td>
    								</tr>
    								<?php $no++; ?>
    							<?php endforeach ?>
