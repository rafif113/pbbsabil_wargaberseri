    							...
    							<?php foreach ($keluhan as $key) : ?>
    								...
    								<tr class="<?= $color ?>">
    									...
    									<td>
    										...
    										<a href="<?= base_url("admin/keluhanaspirasi/deleteKeluhan/$key[id]"); ?>" class="badge badge-danger" onclick="return confirm('Are you sure?');">Hapus</a>
    									</td>
    								</tr>
    								<?php $no++; ?>
    							<?php endforeach ?>
    							...
    							<?php foreach ($aspirasi as $key) : ?>
    								...
    								<tr class="<?= $color ?>">
    									...
    									<td>
    										...
    										<a href="<?= base_url("admin/keluhanaspirasi/deleteAspirasi/$key[id]"); ?>" class="badge badge-danger" onclick="return confirm('Are you sure?');">Hapus</a>
    									</td>
    								</tr>
    								<?php $no++; ?>
    							<?php endforeach ?>
