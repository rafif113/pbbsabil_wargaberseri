...
<body class="authentication-bg authentication-bg-pattern">
				...
				<div class="col-lg-5">
					<div class="card">
						...
						<div class="card-body p-4">
							...
							<div class="error-ghost text-center">
								<svg class="ghost" version="1.1" id="Layer_1" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" width="127.433px" height="132.743px" viewBox="0 0 127.433 132.743" enable-background="new 0 0 127.433 132.743" xml:space="preserve">
							...
							<div class="text-center">
								...
								<h5 class="mt-1">Halaman Tidak Ditemukan! </h5>
								<p class="text-muted mb-0">Halaman tidak tersedia atau Anda salah memasukkan URL</p>
							</div>
					...
					<div class="row mt-3">
						<div class="col-12 text-center">
							<p class="text-white-50">Kembali ke <a href="<?= base_url() ?>" class="text-white ml-1"><b>Beranda</b></a></p>
						</div> <!-- end col -->
					</div>
					<!-- end row -->
	...
	<footer class="footer footer-alt">
		2020 &copy; Perumahan Permata Buah Batu Warga Berseri
	</footer>
